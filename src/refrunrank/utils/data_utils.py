...
#         raise Exception(
#             "ERROR in json_utils.py / writejson: requested output file already exists."
...
#         raise Exception(
#             "ERROR in json_utils.py / injson: both arguments jsonfile and jsondict are None. Specify one of both!"
#         )
#     if jsonfile is not None and jsondict is not None:
#         raise Exception(
#             "ERROR in json_utils.py / injson: both arguments jsonfile and jsondict are given, which leads to ambiguities. Omit one of both!"
#         )
#     if jsondict is None:
...
#     return injson(run, lumi, jsonfile=jsonloc2017) + injson(
#         run, lumi, jsonfile=jsonloc2018
#     )
...
#     jsonloc2017 = (
#         "/eos/user/g/gfidalgo/OMS API/ML4DQM-DC/utils/json_pixel_good_201201.json"
#     )
...
#     jsonloc2017 = (
#         "/eos/user/g/gfidalgo/OMS API/ML4DQM-DC/utils/json_pixel_bad_201201.json"
#     )
...
#         return []
#     if len(plainlist) == 1:
#         return [[plainlist[0], plainlist[0]]]
#     start_index = 0
#     stop_index = 1
#     rangelist = []
...
#         if len(el) != 2:
#             raise Exception(
#                 "ERROR in json_utils.py / rangelist_to_plainlist: found range specifier with length {}".format(
#                     len(el)
#                 )
...
#             lumiranges = [[lslist[0]]]
#         elif len(lslist) == 1:
#             lumiranges = [[lslist[0], lslist[0]]]
#         else:
#             lumiranges = plainlist_to_rangelist(lslist)
...
#             commonls = list(
#                 set(commonls) & set(rangelist_to_plainlist(lumiranges_other))
#             )
#             if len(commonls) == 0:
#                 hascommon = False
#                 break
